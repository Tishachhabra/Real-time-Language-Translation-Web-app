...
const Dashboard = () => {
  ...
  useEffect(() => {
    const baseUrl = "https://ivaanibackendfr.indikaai.com/";
  ...
  useEffect(() => {
    let ws = new WebSocket('wss://ivaanibackendfr.indikaai.com/ws');
    ...
    const handleClose = (event) => {
      ...
      setTimeout(() => {
        ws = new WebSocket('wss://ivaanibackendfr.indikaai.com/ws');
